...
public class CartService {
    ...
    public boolean validateCartItem(Long cartItemId, String email){
        ...
        if (StringUtils.equals(member.getEmail(), cartMember.getEmail())) return true;
//        if (member.getEmail().equals(cartMember.getEmail())) return true; 위와 동일
        else return false;
    ...
    public Long orderCartItem(List<CartOrderDto> cartOrderDtoList, String email) {
        ...
        for (CartOrderDto cartOrderDto : cartOrderDtoList) {
            CartItem cartItem = cartItemRepository.findById(cartOrderDto.getCartItemId()).orElseThrow(NullPointerException::new);
            cartItemRepository.delete(cartItem);
        }
        return orderId;
    }
